...
%Forward Propgation 
%expanding y into a matrix of single values 
...
Theta1_grad = Theta1_grad .+ (lambda/m).* orig_Theta1 ; 
Theta2_grad = Theta2_grad .+ (lambda/m).* orig_Theta2 ;
